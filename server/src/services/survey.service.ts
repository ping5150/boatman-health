...
export const surveyService = {
  ...
  async submitNutritionSurvey(userId: string, formData: NutritionSurveyData) {
    ...
    const submission = await prisma.nutritionSurvey.create({
      data: {
        ...
        weightChangeHistory: formData.weightChangeHistory,
        ...
        bingeFrequency: formData.bingeFrequency,
        emotionalEatingFrequency: formData.emotionalEatingFrequency,
        lateNightSnackFrequency: formData.lateNightSnackFrequency,
        eatingOutFrequency: formData.eatingOutFrequency,
        hasHousekeeper: formData.hasHousekeeper,
        takeoutFrequency: formData.takeoutFrequency,
        socialDiningFrequency: formData.socialDiningFrequency,
        serviceTypes: formData.serviceTypes,
        serviceTypesOther: formData.serviceTypesOther,
        personalizationPreferences: formData.personalizationPreferences,
  ...
  async getNutritionSurveyDetail(userId: string, id: number): Promise<NutritionSurveyDetail> {
    ...
    const formData: NutritionSurveyData = {
      ...
      weightChangeHistory: submission.weightChangeHistory ?? undefined,
      weightGoal: submission.weightGoal ?? undefined,
      bodyComposition: submission.bodyComposition ?? undefined,
      ...
      macroRatio: submission.macroRatio ?? undefined,
      foodQuality: submission.foodQuality ?? undefined,
      mealRegularity: submission.mealRegularity ?? undefined,
      bingeFrequency: submission.bingeFrequency ?? undefined,
      emotionalEatingFrequency: submission.emotionalEatingFrequency ?? undefined,
      lateNightSnackFrequency: submission.lateNightSnackFrequency ?? undefined,
      eatingOutFrequency: submission.eatingOutFrequency ?? undefined,
      hasHousekeeper: submission.hasHousekeeper ?? undefined,
      takeoutFrequency: submission.takeoutFrequency ?? undefined,
      socialDiningFrequency: submission.socialDiningFrequency ?? undefined,
      ...
      serviceTypes: submission.serviceTypes ?? undefined,
      serviceTypesOther: submission.serviceTypesOther ?? undefined,
      personalizationPreferences: submission.personalizationPreferences ?? undefined,
      complianceScore: submission.complianceScore ?? undefined,
      feedbackFrequency: submission.feedbackFrequency ?? undefined,
    };
