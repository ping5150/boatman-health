...
// POST /api/sleep-survey — 提交睡眠问卷
router.post('/', authMiddleware, validate(sleepSurveySchema), sleepSurveyController.submit);

// POST /api/sleep-survey/draft — 保存草稿
router.post('/draft', authMiddleware, validate(sleepSurveyUpdateSchema), sleepSurveyController.saveDraft);
