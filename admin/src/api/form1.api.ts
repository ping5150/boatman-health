...
export const form1Api = {
   ...
   * 获取表单1列表
   */
  getList(params: { page: number; limit: number; search?: string }): Promise<ApiResponse<PaginatedResult<Form1ListItem>>> {
   ...
   * 获取表单1详情
   */
  getDetail(id: number): Promise<ApiResponse<Form1Detail>> {
