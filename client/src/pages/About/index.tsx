...
const About = () => {
  return (
    <>
      ...
      <main className="pt-6 px-6 max-w-5xl mx-auto space-y-20">
        {/* Hero Section */}
        <section className="relative">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            <div className="md:col-span-7 space-y-8 z-10">
              <div className="inline-block px-4 py-1 rounded-full bg-primary/10 text-[#005a9e] text-xs font-bold tracking-widest uppercase">服务理念</div>
              <h2 className="font-headline text-5xl md:text-7xl font-extrabold tracking-tighter leading-none text-[#005a9e]">
                渡人 <br /> 亦渡心
              </h2>
              ...
              <div className="flex items-center gap-4 pt-4">
                <div className="w-12 h-[1px] bg-[#005a9e]"></div>
                <span className="text-sm font-semibold tracking-widest text-[#005a9e]">黑塞《悉达多》的启示</span>
              </div>
            </div>
            <div className="md:col-span-5 relative">
              <div className="aspect-[4/5] rounded-[2rem] overflow-hidden editorial-shadow transform rotate-3 hover:rotate-0 transition-transform duration-700">
                <img alt="Atmospheric high-end river landscape with a serene boat at dawn" className="w-full h-full object-cover" src={img02} />
              </div>
              <div className="absolute -bottom-10 -left-10 w-40 h-40 rounded-full bg-[#005a9e]/5 -z-10 blur-3xl"></div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-4">
              <h3 className="font-headline text-3xl font-bold text-[#005a9e] border-l-4 border-[#005a9e] pl-4">品牌故事</h3>
            ...
            <div className="font-headline text-6xl md:text-8xl font-black text-outline-variant/40 tracking-tighter">成立于 2020</div>
          </div>
        </section>

        {/* Expertise Section */}
        <section className="space-y-10">
          <h3 className="font-headline text-3xl font-bold text-[#005a9e] border-l-4 border-[#005a9e] pl-4">品牌积淀</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-surface-container-low p-8 rounded-[2.5rem] flex flex-col items-center text-center space-y-4 border border-outline-variant/20 hover:bg-[#005a9e]/5 transition-colors duration-300">
              <div className="w-16 h-16 rounded-full bg-[#005a9e]/10 flex items-center justify-center text-[#005a9e]">
                <span className="material-symbols-outlined text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>history_edu</span>
              </div>
              <div className="space-y-1">
                <div className="text-4xl font-headline font-extrabold text-[#005a9e]">5年</div>
                <div className="text-lg font-bold text-[#005a9e] tracking-wide uppercase">深耕积淀</div>
              </div>
            ...
            <div className="bg-surface-container-low p-8 rounded-[2.5rem] flex flex-col items-center text-center space-y-4 border border-outline-variant/20 hover:bg-[#005a9e]/5 transition-colors duration-300">
              ...
              <div className="space-y-1">
                <div className="text-4xl font-headline font-extrabold text-[#005a9e]">1000+</div>
                <div className="text-lg font-bold text-[#005a9e] tracking-wide uppercase">高净值客户服务经验</div>
              </div>
        ...
        <section className="space-y-10">
          <div className="space-y-1">
            <h3 className="font-headline text-3xl font-bold text-[#005a9e] border-l-4 border-[#005a9e] pl-4">跨学科专家团队</h3>
          ...
          <div className="bg-surface-container-low p-8 md:p-12 rounded-[2.5rem] border border-outline-variant/20 space-y-12">
            <div className="flex flex-col md:flex-row md:items-center gap-6 pb-8 border-b border-outline-variant/20">
              <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-[#005a9e]/20">
              ...
              <div className="space-y-2">
                <div className="text-3xl font-headline font-extrabold text-[#005a9e]">10年+</div>
                <div className="text-lg font-bold text-[#005a9e] tracking-wide uppercase">高端医疗深耕积淀</div>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-headline font-bold text-lg text-[#005a9e] flex items-center gap-2">
                    <span className="material-symbols-outlined text-[#005a9e] text-xl">account_balance</span>
                    成员构成
                  </h4>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-headline font-bold text-lg text-[#005a9e] flex items-center gap-2">
                    <span className="material-symbols-outlined text-[#005a9e] text-xl">school</span>
                    专业背景
                  </h4>
        ...
        <section className="bg-[#005a9e] text-white rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="space-y-8">
              <h3 className="font-headline text-4xl font-bold leading-tight text-white">专业医疗管家服务理念</h3>
            ...
            <div className="grid grid-cols-1 gap-8">
              {[
                ...
                <div key={item.icon} className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="font-headline font-bold text-xl mb-2 text-white">{item.title}</h4>
        ...
        <section className="text-center py-10 space-y-12">
          <div className="space-y-4">
            <h3 className="font-headline text-3xl font-bold text-[#005a9e]">开启您的健康管理之旅</h3>
            <p className="text-on-surface-variant max-w-lg mx-auto leading-relaxed">私人咨询服务仅限受邀或推荐预约，诚邀您通过以下方式与我们取得联系。</p>
          </div>
          <div className="flex flex-col gap-4 max-w-sm mx-auto">
            <Link to="/consultation" className="w-full bg-white border-2 border-[#005a9e] text-[#005a9e] py-4 rounded-2xl font-bold flex items-center justify-center gap-2 active:scale-[0.98] transition-all">
              <span className="material-symbols-outlined">calendar_month</span>
              <span>立即预约咨询</span>
            </Link>
            <div className="mt-6 p-6 bg-[#005a9e]/5 rounded-3xl border border-[#005a9e]/10 space-y-4">
              <div className="flex items-center justify-center gap-2 text-[#005a9e] font-bold">
                <span className="material-symbols-outlined">chat</span>
                <span>专属微信管家</span>
              </div>
              <p className="text-xs text-on-surface-variant">扫描宣传手册二维码或点击下方按钮添加</p>
              <Link to="/account/contact" className="inline-flex items-center gap-2 bg-[#005a9e] text-white px-6 py-3 rounded-full text-sm font-bold active:scale-95 transition-all">
