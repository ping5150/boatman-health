...
const Paradigm = () => {
  const paradigmFeatures = [
    ...
    { icon: 'groups', title: '全球顾问委员会', subtitle: '打破地域限制的顶级医疗资源', description: '直连来自全球五大顶级医学中心的资深顾问团队。无论您身在何处，都能获得与国际同步的诊疗建议。我们的顾问网络覆盖心血管、肿瘤、神经内科、内分泌等所有主要医学领域。', benefits: ['跨学科专家联合会诊', '第二诊疗意见服务', '国际前沿疗法接入', '紧急咨询通道'] },
