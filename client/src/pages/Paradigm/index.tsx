...
const Paradigm = () => {
  const paradigmFeatures = [
    ...
    { icon: 'verified', title: '1对1 首席顾问', subtitle: '专属健康管家，全程陪伴守护', description: '每位客户配备一位具有资深临床背景的首席健康顾问，为您提供7x24小时全时决策支持。从健康评估、方案制定到康复跟进，您的首席顾问将全程陪伴，确保每一个决策都经过深思熟虑的专业分析。', benefits: ['专属健康档案管理', '定期健康评估报告', '就医陪同与专家预约', '紧急情况快速响应'] },
  ];
