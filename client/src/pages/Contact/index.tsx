  ...
  return (
    <div className="flex flex-col items-center justify-center px-8 py-12 min-h-[70vh]">
      ...
      <div className="w-full mb-12 text-center">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary-container mb-6 shadow-sm">
          <Icon name="support_agent" filled size={36} className="text-secondary-container" />
        </div>
        <h2 className="font-headline font-extrabold text-2xl text-primary tracking-tight mb-4">Boatman Health</h2>
      ...
      <div className="relative w-full max-w-[280px] aspect-square bg-surface-container-lowest rounded-[2rem] p-6 shadow-elevated group overflow-hidden">
        ...
        <div className="relative w-full h-full bg-white rounded-xl flex flex-col items-center justify-center p-4 gap-4">
